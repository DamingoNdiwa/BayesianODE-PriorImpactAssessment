...
filtered_df = df.loc[(df['date'] >= '2020-02-29') & (df['date'] <= '2020-06-13') & (df['location'] == 'Luxembourg'), ["date",
                                                                                                                      "population", 'total_cases', 'new_cases', "hosp_patients", "icu_patients", "reproduction_rate", "total_deaths", "new_deaths"]]
data_plot = df.loc[(df['date'] >= '2020-02-29') & (df['date'] <= '2020-07-29') & (df['location'] == 'Luxembourg'),
                   ["date",
                    "population",
                    'total_cases',
                    'new_cases',
