...
pos_samples0 = post_samples(num_results, num_burnin_steps, key, phi=5)
# Second prior
pos_samples1 = post_samples(num_results, num_burnin_steps, key, phi=42)
# Third prior

pos_samples2 = post_samples(num_results, num_burnin_steps, key, phi=1)
# fourth prior
pos_samples3 = post_samples1(num_results, num_burnin_steps, key, a=16)
# fifth prior
pos_samples4 = post_samples(num_results, num_burnin_steps, key, phi=150)
...
gs = fig.add_gridspec(
    3, 2, width_ratios=widths, height_ratios=heights, wspace=0.2, hspace=0.15
)
...
f3_ax1.set_xticklabels(
    ["29-Feb", "31-March", "30-April", "30-May", "29-June"], rotation=12
)
...
f3_ax22.plot(
    data_plot.new_cases.values, "ko", mfc="none", ms=1.5, label="observed", alpha=0.5
)
f3_ax22.plot(
    mu4, "y-", label=r"$\phi^{-1} \stackrel{\text{iid}}{\sim} \text{Exponential}(150)$"
)
f3_ax22.fill_between(
    data_plot.date.values[:-1],
    pi4[0],
    pi4[1],
    color="blue",
    alpha=0.4,
...
f3_ax22.set_xticklabels(
    ["29-Feb", "31-March", "30-April", "30-May", "29-June"], rotation=20
)
legend_elements = [
    Line2D(
        [0],
...
axs[1, 1].set_xticklabels(
    ["29-Feb", "31-March", "30-April", "30-May", "29-June"], rotation=28
)
legend_elements = [
    Line2D(
        [0],
